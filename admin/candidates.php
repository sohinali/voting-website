...
<CAPTION><h3 style="color:white;">ADD NEW CANDIDATE</h3></CAPTION>
<form name="fmCandidates" id="fmCandidates" action="candidates.php" method="post" onsubmit="return candidateValidate(this)">
<tr>
    <td bgcolor="orange" style="color:black;">Candidate Name</td>
    <td bgcolor="orange"><input type="text" name="name" /></td>
</tr>

<tr>
    <td bgcolor="white" style="color:black;">Candidate Position</td>
    
    <td bgcolor="white" style="color black"><SELECT NAME="position" id="position" style ="color: black;">select
...
<tr>
    <td bgcolor="green">&nbsp;</td>
    <td bgcolor="green" style="color:black;"><input type="submit" name="Submit" value="Add" /></td>
</tr>
</table>
<hr>
<table border="0" width="620" align="center">
<CAPTION><h3 style="color:white;">AVAILABLE CANDIDATES</h3></CAPTION>
<tr>
<th>Candidate ID</th>
